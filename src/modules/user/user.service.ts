...
export class UserService {
    ...
    constructor(
        ...
        @InjectModel('ForgotPassword') private readonly forgotPasswordModel: Model<IForgotPassword>,
        private readonly authService: AuthService,
    ) {}

    query(options) {
        // return this.userModel.find(options).lean();
    ...
    // ┴  ┴└─ ┴ └─┘└─┘ ┴ └─┘─┴┘  └─┘└─┘┴└─ └┘ ┴└─┘└─┘
    findAll(): any {
        // findAll(channelId: string, page: number = 1, limit: number = 10): any {
        // const options = {
        //     populate: [
    ...
    private async findForgotPasswordByUuid(verifyUuidDto: VerifyUuidDto): Promise<IForgotPassword> {
    ...
    private async setForgotPasswordFirstUsed(req: Request, forgotPassword: IForgotPassword) {
    ...
    private async findForgotPasswordByEmail(resetPasswordDto: ResetPasswordDto): Promise<IForgotPassword> {
        const forgotPassword = await this.forgotPasswordModel.findOne({
            email: resetPasswordDto.email,
            firstUsed: true,
            finalUsed: false,
    ...
    private async setForgotPasswordFinalUsed(forgotPassword: IForgotPassword) {
...
// @Injectable()
// export class UserService {
//     constructor(private readonly userRepository: UserRepository, @InjectModel('User') private readonly userModel: Model<IUser>) {}
