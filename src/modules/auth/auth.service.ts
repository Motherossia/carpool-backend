import { IJwt } from './interfaces/jwt-payload.interface';
...
export class AuthService {
    ...
    async validateUser(jwt: IJwt): Promise<any> {
        const user = await this.userModel.findOne({ _id: jwt.userId, verified: true });
        if (!user) {
